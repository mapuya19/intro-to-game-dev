	...
	case state.flip_score:
		if (cpu_flip == false) {
			...
			if (global.cpu_card.face_up == true) {
				...
				if ((card_one.card_type == face_index.scissors && card_two.card_type == face_index.rock) || (card_one.card_type == face_index.paper && card_two.card_type == face_index.scissors) || (card_one.card_type == face_index.rock && card_two.card_type == face_index.paper)) {
					// player lost round
					...
					if ((card_one.card_type == face_index.scissors && card_two.card_type == face_index.paper) || (card_one.card_type == face_index.rock && card_two.card_type == face_index.scissors) || (card_one.card_type == face_index.paper && card_two.card_type == face_index.rock)) {
						//player won round
						if (global.score_updated == false) {
